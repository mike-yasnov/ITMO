...
/**
 * Класс Executor предназначен для выполнения команд в интерактивном режиме или из скрипта.
 */
public class Executor {
     ...
     * @param console объект, представляющий консольное взаимодействие
     ...
     * @param scriptScanner сканнер для чтения скрипта
     * @return true, если можно выполнять скрипт, в противном случае false
     */
    ...
    /**
     * Запускает скрипт для выполнения команд.
