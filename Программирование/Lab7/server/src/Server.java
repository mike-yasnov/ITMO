...
public class Server {
    ...
    public static void main(String[] args) {
        ...
        var commandManager = new CommandManager() {{
            ...
            register("reorder", new Reorder(collectionManager, dbManager));
            register("print_ascending", new PrintAscending(collectionManager, dbManager));
            register("filter_by_price", new FilterByPrice(collectionManager));
            register("print_field_descending_unit_of_measure", new PrintFieldDescendingUnitOfMeasure(collectionManager, dbManager));
            register("update", new Update(collectionManager, dbManager));
            register("remove_at", new RemoveAt(collectionManager, dbManager));
