...
//        this.scriptExecutor = new ScriptExecutor(this);
        ...
        do {
            try {
                ...
                if (y <= 469) {
                    ...
                    System.out.println("Ошибка: Максимальное значение y: 469. Пожалуйста, введите число заново.");
                }
            } catch (NumberFormatException e) {
                System.out.println("Ошибка: Некорректный формат числа. Пожалуйста, введите число заново.");
            }
        ...
        do {
            try {
                ...
                if (partNumber.length() >= 16) {
                    ...
                    System.out.println("Ошибка: Номер партии должен быть больше 16 символов. Пожалуйста, введите заново.");
                }
            } catch (IllegalArgumentException e) {
                System.out.println(e.getMessage());
            }
    ...
    private void updateProduct(String args) {
        ...
        Product updatedProduct = new Product(name, new Coordinates(x, y), price, partNumber, manufacturePrice, unitOfMeasure, owner);
